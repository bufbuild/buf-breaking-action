...
> functionality of `buf-breaking-action` with the ability to run Buf commands in the same step. Please
...
[buf-action-migration]: https://github.com/bufbuild/buf-action/blob/main/MIGRATION.md#buf-breaking-action
